        ...
        <div className="flex flex-col gap-1 justify-center items-center w-3/4 lg:w-1/2">
          ...
          <Highlight>
            <p
              ...
              onClick={() => {
                navigator.clipboard.writeText("nhanphan1159@gmail.com");
              }}
              className="text-2xl lg:text-3xl cursor-pointer"
            >
              <b>nhanphan1159@gmail.com</b>
            </p>
          </Highlight>
          <ul className="flex gap-8 mt-3">
            ...
            <MotionDiv delay={0.7}>
              <a href="https://github.com/nhanphan1159" data-tooltip-id="githublogo" target="_blank">
            ...
            <MotionDiv delay={0.8}>
              <a
                href="https://linkedin.com/in/nhanphan1159"
            ...
            <MotionDiv delay={0.9}>
              <a
                href="https://leetcode.com/u/nhanphan1159/"
